...
def UserMachineLearning(request):
    ...
    plt.figure(figsize=(7, 6))
    ax = sns.barplot(x=dataset["sex"].replace({1: "Male" ,0: "Female"}), y=y, ci=None)
    for p in ax.patches:
    ...
    dataset["cp"].unique()
    plt.figure(figsize=(7, 6))
    ax = sns.barplot(x=dataset["cp"].replace({0: "Typical Angina", 1: "Atypical Angina", 2: "Non-Anginal Pain", 3: "Asymptomatic"}), y=y, ci=None)
    for p in ax.patches:
        ax.annotate(f'{round(p.get_height(), 2)}', (p.get_x() + p.get_width() / 2., p.get_height()),
                    ha='center', va='center', xytext=(0, 6), textcoords='offset points', fontsize=14)
    plt.title("Bar Plot")
    ...
    dataset["fbs"].unique()
    plt.figure(figsize=(7, 6))
    ax =sns.barplot(x=dataset["fbs"].replace({0 : "<=120 mg/Dl",1 : " > 120 mg/Dl"}), y=y, ci=None)
    for p in ax.patches:
        ax.annotate(f'{round(p.get_height(), 2)}', (p.get_x() + p.get_width() / 2., p.get_height()),
                    ha='center', va='center', xytext=(0, 6), textcoords='offset points', fontsize=14)
    plt.title("Bar Plot")
    ...
    plt.figure(figsize=(7, 6))
    ax =sns.barplot(x=dataset["restecg"], y=y, ci=None)
    for p in ax.patches:
        ax.annotate(f'{round(p.get_height(), 2)}', (p.get_x() + p.get_width() / 2., p.get_height()),
                    ha='center', va='center', xytext=(0, 6), textcoords='offset points', fontsize=14)
    plt.title("Bar Plot")
    ...
    plt.figure(figsize=(7, 6))
    ax =sns.barplot(x=dataset["exang"].replace({0 : "No", 1 : "Yes"}), y=y, ci=None)
    for p in ax.patches:
        ax.annotate(f'{round(p.get_height(), 2)}', (p.get_x() + p.get_width() / 2., p.get_height()),
                    ha='center', va='center', xytext=(0, 6), textcoords='offset points', fontsize=14)
    plt.title("Bar Plot")
    ...
    plt.figure(figsize=(7, 6))
    ax = sns.barplot(x=dataset["slope"].replace({0 : "Up-sloping", 1: "Flat", 2: "Down-sloping"}), y=y, ci=None)
    for p in ax.patches:
        ax.annotate(f'{round(p.get_height(), 2)}', (p.get_x() + p.get_width() / 2., p.get_height()),
                    ha='center', va='center', xytext=(0, 6), textcoords='offset points', fontsize=14)
    plt.title("Bar Plot")
    ...
    plt.show()
    plt.figure(figsize=(7, 6))
    ax = sns.barplot(x=dataset["ca"], y=y, ci = None)
    for p in ax.patches:
        ax.annotate(f'{round(p.get_height(), 2)}', (p.get_x() + p.get_width() / 2., p.get_height()),
                    ha='center', va='center', xytext=(0, 6), textcoords='offset points', fontsize=14)
    plt.title("Bar Plot")
    ...
    dataset["thal"].unique()
    plt.figure(figsize=(7, 6))
    ax = sns.barplot(x=dataset["thal"].replace({0 : "Mixed Defect", 1 : "Normal", 2 : "Fixed Defect", 3 : "Reversible Defect"}), y=y, ci=None)
    for p in ax.patches:
        ax.annotate(f'{round(p.get_height(), 2)}', (p.get_x() + p.get_width() / 2., p.get_height()),
                    ha='center', va='center', xytext=(0, 6), textcoords='offset points', fontsize=14)
    plt.title("Bar Plot")
...
def alggg(k_test):
    ...
    df = pd.read_csv(r"C:\Users\deepu\OneDrive\Desktop\Major Project\heart disease\Heart\media\heart.csv")
